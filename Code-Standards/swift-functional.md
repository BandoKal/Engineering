<!-- title:Styling - Swift Functional, description:Coding style for Swift project following functional-->
# Swift (Functional)
...
Place your code into logical blocks of functionality. Each extension should be set off with a `// MARK: -` comment to keep things well-organized. 
